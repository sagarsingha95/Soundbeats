...
const menuItems = [
  ...
  {
    name: "Playlist",
    icon: <MdOutlinePlaylistPlay size={30} />,
    path: "/playlist",
    id: 3,
  },
];
...
const SideBar = () => {
  ...
  return (
    <>
      ...
      {/* Mobile Top Nav */}
      <div className="md:hidden sticky top-0 w-full bg-[#121212] text-white flex justify-around p-2 z-50 border-b border-white/10  flex-col ">
        <h1 className="text-[20px] font-bold flex m-auto mb- gap-2 pb-4 !text-4xl bg-gradient-to-r from-blue-600 via-green-500 to-indigo-400 bg-clip-text text-transparent">
          <FaMusic color="green" /> Sound Beats
        </h1>
